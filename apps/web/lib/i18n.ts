...
export const translations: Translations = {
    en: {
        ...
        memoriesDesc: 'Ascuita can keep concise, non-sensitive facts to personalize future conversations.',
        memoriesEnabled: 'Allow automatic memories',
        memoriesEnabledDesc: 'When enabled, Ascuita may save useful long-term facts from your conversations.',
        memoriesDisabledDesc: 'Automatic memory saving is disabled. Existing memories remain available until you delete them.',
        memoriesEmpty: 'No memories saved yet.',
        memoriesLoginRequired: 'Sign in to manage persistent memories.',
        memoriesCategory: 'Category',
        memoriesDate: 'Updated',
        memoriesDelete: 'Delete memory',
        memoriesClear: 'Delete all memories',
        memoriesClearConfirm: 'Delete all persistent memories? This cannot be undone.',
        memoriesExport: 'Export memories',
        memoriesExportError: 'The memories could not be exported.',
        memoryCategoryPreference: 'Preference',
        memoryCategoryPersonalFact: 'Personal fact',
        ...
        wsBlockedError: 'Could not open the WebSocket. Disable Brave Shields or ad blockers for this site, then try again.',
    ...
    es: {
        ...
        memoriesDesc: 'Ascuita puede conservar datos breves y no sensibles para personalizar futuras conversaciones.',
        memoriesEnabled: 'Permitir memorias automáticas',
        memoriesEnabledDesc: 'Cuando está activado, Ascuita puede guardar datos útiles y duraderos de tus conversaciones.',
        memoriesDisabledDesc: 'El guardado automático está desactivado. Las memorias existentes permanecen hasta que las elimines.',
        memoriesEmpty: 'Todavía no hay memorias guardadas.',
        memoriesLoginRequired: 'Inicia sesión para gestionar tus memorias persistentes.',
        memoriesCategory: 'Categoría',
        memoriesDate: 'Actualizada',
        memoriesDelete: 'Eliminar memoria',
        memoriesClear: 'Eliminar todas las memorias',
        memoriesClearConfirm: '¿Eliminar todas las memorias persistentes? Esta acción no se puede deshacer.',
        memoriesExport: 'Exportar memorias',
        memoriesExportError: 'No se pudieron exportar las memorias.',
        memoryCategoryPreference: 'Preferencia',
        memoryCategoryPersonalFact: 'Dato personal',
        memoryCategoryGoal: 'Objetivo',
        memoryCategoryContext: 'Contexto',
        letsGo: '¡Vamos!',
        // EditAgent
        name: 'Nombre',
        ...
        wsBlockedError: 'No se pudo abrir el WebSocket. Desactiva Brave Shields o bloqueadores de anuncios para este sitio y vuelve a intentarlo.',
