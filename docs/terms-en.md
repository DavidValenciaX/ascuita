...
You retain ownership of the content you create in the Service (agents, conversations, messages, profile, and memories). By using the Service, you grant us a non-exclusive, royalty-free, temporary license to process and store such content solely for the purpose of providing the Service.
...
- Memories may be incomplete, outdated, or incorrect because the model decides when to request them. You should review and delete any memory that is not accurate.
...
- The Operator **shall not be liable** for:
  ...
  - Loss of data, conversations, stored agents, or memories.
